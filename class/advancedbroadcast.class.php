...
class AdvancedBroadcast{
     ...
     * @param $articles = array(
                            array('thumb_media_id'=>'多媒体ID，由多媒体上传接口获得' , 'author'=>'作者', 'title'=>'标题', 'content_source_url'=>'www.lanecn.com','content'=>'内容', 'digest'=>'摘要', 'show_cover_pic'=>'是否设置为封面（0或者1）'),
                            array('thumb_media_id'=>'多媒体ID，由多媒体上传接口获得' , 'author'=>'作者', 'title'=>'标题', 'content_source_url'=>'www.lanecn.com','content'=>'内容', 'digest'=>'摘要', 'show_cover_pic'=>'是否设置为封面（0或者1）'),
     *                  )
     *
     ...
     * @return mixed array("errcode"=>0, "errmsg"=>"ok"} 正常是errcode为0
     */
    public static function preview($touser ,$type , $media_id){
		...
		if($type == 'text'){
			$template[$type]["content"] = $media_id;
		}else{
			$template[$type]["media_id"] = $media_id;
		}
